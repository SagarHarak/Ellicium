...
-- IF (OBJECT_ID('icr.FK_icr_basket_commodities_basket_id', 'F') IS NOT NULL)
-- BEGIN
--     ALTER TABLE icr.basket_commodities
--  DROP CONSTRAINT FK_icr_basket_commodities_basket_id
-- END


-- IF (OBJECT_ID('stg.FK_stg_commodities_id', 'F') IS NOT NULL)
-- BEGIN
--     ALTER TABLE stg.commodities
--  DROP CONSTRAINT FK_stg_commodities_id
-- END
...
IF (OBJECT_ID('target.FK_target_commodities_commodity_id', 'F') IS NOT NULL)
BEGIN
    ALTER TABLE target.commodities
 DROP CONSTRAINT FK_target_commodities_commodity_id
END

-- IF (OBJECT_ID('icr.FK_icr_basket_commodities_commodity_id', 'F') IS NOT NULL)
-- BEGIN
--     ALTER TABLE icr.basket_commodities
--  DROP CONSTRAINT FK_icr_basket_commodities_commodity_id
-- END
...
--  DROP CONSTRAINT FK_cost_estimation_formula_project_id
-- END
...
--  DROP CONSTRAINT FK_cost_estimation_summary_project_id
-- END


IF (OBJECT_ID('target.FK_target_dim_article_vendor', 'F') IS NOT NULL)
BEGIN
    ALTER TABLE target.dim_article
 DROP CONSTRAINT FK_target_dim_article_vendor
END
...
--  DROP CONSTRAINT FK_dim_cost_estimation_commodities_section_id
-- END
...
IF (OBJECT_ID('target.FK_target_dim_project_article_id', 'F') IS NOT NULL)
BEGIN
    ALTER TABLE target.dim_project
 DROP CONSTRAINT FK_target_dim_project_article_id
END
...
IF (OBJECT_ID('target.FK_target_dim_project_cost_details_element_id', 'F') IS NOT NULL)
BEGIN
    ALTER TABLE target.dim_project_cost_details
 DROP CONSTRAINT FK_target_dim_project_cost_details_element_id
END


IF (OBJECT_ID('target.FK_target_dim_project_cost_details_subsection_id', 'F') IS NOT NULL)
BEGIN
    ALTER TABLE target.dim_project_cost_details
 DROP CONSTRAINT FK_target_dim_project_cost_details_subsection_id
END

IF (OBJECT_ID('target.FK_target_forecast_article', 'F') IS NOT NULL)
BEGIN
    ALTER TABLE target.forecast
 DROP CONSTRAINT FK_target_forecast_article
END

IF (OBJECT_ID('target.FK_retail_aur_article', 'F') IS NOT NULL)
BEGIN
    ALTER TABLE target.retail_aur
 DROP CONSTRAINT FK_retail_aur_article
END


IF (OBJECT_ID('target.FK_target_tariff_tariff_id', 'F') IS NOT NULL)
BEGIN
    ALTER TABLE target.tariff
 DROP CONSTRAINT FK_target_tariff_tariff_id
END


IF (OBJECT_ID('target.FK_target_vendor_funding_vendor_id', 'F') IS NOT NULL)
BEGIN
    ALTER TABLE target.vendor_funding
 DROP CONSTRAINT FK_target_vendor_funding_vendor_id
END
