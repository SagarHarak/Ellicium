...
# Adding API permission in client reg app

# $objectID = ""
# $User.Read = "df021288-bdef-4463-88db-98f22de89214"

# Add-AzADAppPermission -ObjectId $objectID -ApiId 00000003-0000-0000-c000-000000000000 -PermissionId $User.Read -Type Role

# Adding Client Secret to Client reg app
# $ClientId = ""
# $ClientSecretvalue = ""


# Adding Authentication Identity provider in function app
# $IdentityProvider = "Microsoft"
# $ResourceGroupName = "EL-AZ-TESTING"
# $secretvalue = "5pr8Q~Bbdh6zXsaHXT-fPRRwIktoP_q8IIIh2dBL"
# $ServiceName = "contoso"
# $apimContext = New-AzApiManagementContext -ResourceGroupName $ResourceGroupName -ServiceName "contoso"
# New-AzApiManagementIdentityProvider -Context $apimContext -Type $IdentityProvider -ClientId "1e9afec9-27d7-4deb-bf0b-1f20a844cc6e" -ClientSecret $secretvalue
# >
